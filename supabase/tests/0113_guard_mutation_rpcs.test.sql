...
insert into auth.users (id, email) values
  ('cccccccc-0000-0000-0000-000000gm0001','gm-owner@example.test'),
  ('cccccccc-0000-0000-0000-000000gm0002','gm-viewer@example.test') on conflict do nothing;
insert into public.profiles (id, role, display_name) values
  ('cccccccc-0000-0000-0000-000000gm0001','owner','GM Owner'),
  ('cccccccc-0000-0000-0000-000000gm0002','viewer','GM Viewer');
insert into public.places (id,name,lat,lng,saved) values
  ('dddddddd-0000-0000-0000-000000gm0001','GM A',1,1,true),
  ('dddddddd-0000-0000-0000-000000gm0002','GM B',2,2,true);

-- VIEWER: both mutations must raise 'not authorized'.
set local role authenticated;
set local request.jwt.claims = '{"sub":"cccccccc-0000-0000-0000-000000gm0002"}';
do $$
begin
  begin
    perform public.dismiss_duplicate('dddddddd-0000-0000-0000-000000gm0001','dddddddd-0000-0000-0000-000000gm0002');
...
set local role authenticated;
set local request.jwt.claims = '{"sub":"cccccccc-0000-0000-0000-000000gm0001"}';
do $$
begin
  perform public.dismiss_duplicate('dddddddd-0000-0000-0000-000000gm0001','dddddddd-0000-0000-0000-000000gm0002');
  if not exists (select 1 from public.dup_dismissed
                 where place_a='dddddddd-0000-0000-0000-000000gm0001'
                   and place_b='dddddddd-0000-0000-0000-000000gm0002') then
